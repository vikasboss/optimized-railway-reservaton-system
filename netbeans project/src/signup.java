...
public class signup extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel5.setText("ADRESS LINE 3");

        jLabel6.setText("PHONE NUMBER");

        jLabel7.setText("EMAIL ID");

        jLabel8.setText("CUSTOM USERID");

        jLabel9.setText("CUSTOM PASSWORD");
...
String query="INSERT INTO table1 VALUES('"+Name+"','"+a1+"','"+a2+"','"+a3+"','"+pno+"','"+em+"','"+cid+"','"+pid+"');";
String query1="INSERT INTO table2 VALUES('"+cid+"','"+pid+"');";
...
JOptionPane.showMessageDialog (this, e.getMessage());
    ...
    private javax.swing.Jimport java.sql.DriverManager;
import com.mysql.jdbc.Connection;
import com.mysql.jdbc.Statement;
import javax.swing.JFrame;
import javax.swing.JOptionPane;
